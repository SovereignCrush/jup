...
It is now prepared for the `0.1.0-alpha.4` npm alpha.
...
- `docs/releases/0.1.0-alpha.4.md` matches the release scope.
...
- confirm the npm alpha package uses `0.1.0-alpha.4`;
